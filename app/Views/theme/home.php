				...
				<div class="row justify-content-center">
					<div class="col-xl-11 col-lg-12 col-md-12 col-sm-12 col-12">
						...
						<div class="banner_caption text-center">
							...
							<p class="fs-lg ft-light">Explore wonderful place to stay, salon, shoping, massage or visit
								local areas.</p>
						</div>
						
						<div class="d-block">
							<form class="main-search-wrap fl-wrap mb-4">
								<div class="main-search-item">
									<input type="text" class="form-control radius"
										placeholder="Malls, Colleges, Theaters, Hospitals..." />
								</div>
								<div class="main-search-item">
									<i class="icofont-location-pin"></i>
									<input type="text" class="form-control" placeholder="Coimbatore" />
								</div>
								<div class="main-search-item">
						...
						<div class="Goodup-bnr-cats center">
							<ul>
			...
			<div class="container">
				...
				<div class="row align-items-center">
					...
					<div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6">
						<div class="cats-wrap text-center wow animated fadeInLeft" >
					...
					<div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6">
						<div class="cats-wrap text-center">
							<a href="#" class="Goodup-catg-wrap wow animated fadeInLeft">
		...
		<section class="space min">
			<div class="container">
				...
				<div class="row justify-content-center">
					<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
						<div class="sec_title position-relative text-center mb-5" data-aos="fade-down">
							<h6 class="theme-cl mb-0" >Featured Listings</h6>
							<h2 class="ft-bold" >Goodup in Coimbatore</h2>
						</div>
					</div>
				</div>
				...
				<div class="row align-items-center" >
					<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
						<ul class="nav nav-tabs small-tab mb-3" id="myTab" role="tablist" data-aos="example-anim1">
					...
					<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
						<div class="tab-content" id="myTabContent" >
							...
							<div class="tab-pane fade show active" id="places" role="tabpanel"
								...
								<div class="row justify-content-center">
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="Goodup-grid-wrap"  data-aos="fade-right">
											<div class="Goodup-grid-upper">
												...
												<div class="Goodup-grid-thumb">
													<a href="#" class="d-block text-center m-auto"><img
															src="<?php echo base_url('assets/theme/img/listing/l-5.jpg'); ?>" class="img-fluid"
															alt=""></a>
												</div>
											...
											<div class="Goodup-grid-fl-wrap">
												<div class="Goodup-caption px-3 py-2">
													<div class="Goodup-author"><a href="#"><img src="<?php echo base_url('assets/theme/img/t-1.png'); ?>"
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="Goodup-grid-wrap" data-aos="fade-right">
											<div class="Goodup-grid-upper">
												...
												<div class="Goodup-grid-thumb">
													<a href="#" class="d-block text-center m-auto"><img
															src="<?php echo base_url('assets/theme/img/listing/l-6.jpg'); ?>" class="img-fluid"
															alt=""></a>
												</div>
												<div class="Goodup-rating overlay">
											...
											<div class="Goodup-grid-fl-wrap">
												<div class="Goodup-caption px-3 py-2">
													<div class="Goodup-author"><a href="#"><img src="<?php echo base_url('assets/theme/img/t-2.png'); ?>"
																class="img-fluid circle" alt=""></a></div>
													<h4 class="mb-0 ft-medium medium"><a href="#"
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="Goodup-grid-wrap" data-aos="fade-right">
											<div class="Goodup-grid-upper">
												...
												<div class="Goodup-grid-thumb">
													<a href="#" class="d-block text-center m-auto"><img
															src="<?php echo base_url('assets/theme/img/listing/l-7.jpg'); ?>" class="img-fluid"
															alt=""></a>
												</div>
												<div class="Goodup-rating overlay">
											...
											<div class="Goodup-grid-fl-wrap">
												<div class="Goodup-caption px-3 py-2">
													<div class="Goodup-author"><a href="#"><img src="<?php echo base_url('assets/theme/img/t-3.png'); ?>"
																class="img-fluid circle" alt=""></a></div>
													<h4 class="mb-0 ft-medium medium"><a href="#"
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="Goodup-grid-wrap" data-aos="fade-right">
											<div class="Goodup-grid-upper">
												...
												<div class="Goodup-grid-thumb">
													<a href="#" class="d-block text-center m-auto"><img
															src="<?php echo base_url('assets/theme/img/listing/l-8.jpg'); ?>" class="img-fluid"
															alt=""></a>
												</div>
												<div class="Goodup-rating overlay">
											...
											<div class="Goodup-grid-fl-wrap">
												<div class="Goodup-caption px-3 py-2">
													<div class="Goodup-author"><a href="#"><img src="<?php echo base_url('assets/theme/img/t-4.png'); ?>"
																class="img-fluid circle" alt=""></a></div>
													<h4 class="mb-0 ft-medium medium"><a href="#"
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="Goodup-grid-wrap" data-aos="fade-right">
											<div class="Goodup-grid-upper">
												...
												<div class="Goodup-grid-thumb">
													<a href="#" class="d-block text-center m-auto"><img
															src="<?php echo base_url('assets/theme/img/listing/l-9.jpg'); ?>" class="img-fluid"
															alt=""></a>
												</div>
												<div class="Goodup-rating overlay">
											...
											<div class="Goodup-grid-fl-wrap">
												<div class="Goodup-caption px-3 py-2">
													<div class="Goodup-author"><a href="#"><img src="<?php echo base_url('assets/theme/img/t-5.png'); ?>"
																class="img-fluid circle" alt=""></a></div>
													<h4 class="mb-0 ft-medium medium"><a href="#"
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="Goodup-grid-wrap" data-aos="fade-right">
											<div class="Goodup-grid-upper">
												...
												<div class="Goodup-grid-thumb">
													<a href="#" class="d-block text-center m-auto"><img
															src="<?php echo base_url('assets/theme/img/listing/l-10.jpg'); ?>" class="img-fluid"
															alt=""></a>
												</div>
												<div class="Goodup-rating overlay">
											...
											<div class="Goodup-grid-fl-wrap">
												<div class="Goodup-caption px-3 py-2">
													<div class="Goodup-author"><a href="#"><img src="<?php echo base_url('assets/theme/img/t-6.png'); ?>"
																class="img-fluid circle" alt=""></a></div>
													<h4 class="mb-0 ft-medium medium"><a href="#"
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="Goodup-grid-wrap" data-aos="fade-right">
											<div class="Goodup-grid-upper">
												...
												<div class="Goodup-grid-thumb">
													<a href="#" class="d-block text-center m-auto"><img
															src="<?php echo base_url('assets/theme/img/listing/l-11.jpg'); ?>" class="img-fluid"
															alt=""></a>
												</div>
												<div class="Goodup-rating overlay">
											...
											<div class="Goodup-grid-fl-wrap">
												<div class="Goodup-caption px-3 py-2">
													<div class="Goodup-author"><a href="#"><img src="<?php echo base_url('assets/theme/img/t-7.png'); ?>"
																class="img-fluid circle" alt=""></a></div>
													<h4 class="mb-0 ft-medium medium"><a href="#"
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="Goodup-grid-wrap" data-aos="fade-right">
											<div class="Goodup-grid-upper">
												...
												<div class="Goodup-grid-thumb">
													<a href="#" class="d-block text-center m-auto"><img
															src="<?php echo base_url('assets/theme/img/listing/l-1.jpg'); ?>" class="img-fluid"
															alt=""></a>
												</div>
												<div class="Goodup-rating overlay">
											...
											<div class="Goodup-grid-fl-wrap">
												<div class="Goodup-caption px-3 py-2">
													<div class="Goodup-author"><a href="#"><img src="<?php echo base_url('assets/theme/img/t-8.png'); ?>"
																class="img-fluid circle" alt=""></a></div>
													<h4 class="mb-0 ft-medium medium"><a href="#"
							...
							<!-- Events -->
							<div class="tab-pane fade" id="events" role="tabpanel" aria-labelledby="events-tab" data-aos="fade-right">
								<div class="row justify-content-center">
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="Goodup-grid-wrap" data-aos="fade-right">
											<div class="Goodup-grid-upper">
												...
												<div class="Goodup-grid-thumb">
													<a href="#" class="d-block text-center m-auto"><img
															src="<?php echo base_url('assets/theme/img/listing/l-2.jpg'); ?>" class="img-fluid"
															alt=""></a>
												</div>
												<div class="Goodup-overlay-caps">
													<h4 class="mb-0 ft-medium medium"><a href="#"
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="Goodup-grid-wrap" data-aos="fade-right">
											<div class="Goodup-grid-upper">
												...
												<div class="Goodup-grid-thumb">
													<a href="#" class="d-block text-center m-auto"><img
															src="<?php echo base_url('assets/theme/img/listing/l-3.jpg'); ?>" class="img-fluid"
															alt=""></a>
												</div>
												<div class="Goodup-overlay-caps">
													<h4 class="mb-0 ft-medium medium"><a href="#"
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="Goodup-grid-wrap" data-aos="fade-right">
											<div class="Goodup-grid-upper">
												...
												<div class="Goodup-grid-thumb">
													<a href="#" class="d-block text-center m-auto"><img
															src="<?php echo base_url('assets/theme/img/listing/l-4.jpg'); ?>" class="img-fluid"
															alt=""></a>
												</div>
												<div class="Goodup-overlay-caps">
													<h4 class="mb-0 ft-medium medium"><a href="#"
							...
							<div class="tab-pane fade" id="doctor" role="tabpanel" aria-labelledby="doctor-tab">
								<div class="row justify-content-center">
									...
									<!-- Single -->
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="doctor-grid-view" data-aos="fade-right">
											<div class="doctor-grid-thumb">
												<a href="#"><img src="<?php echo base_url('assets/theme/img/doc-1.jpg'); ?>" class="img-fluid"
														alt=""></a>
											</div>
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="doctor-grid-view" data-aos="fade-right">
											<div class="doctor-grid-thumb">
												<a href="#"><img src="<?php echo base_url('assets/theme/img/doc-2.jpg'); ?>" class="img-fluid"
														alt=""></a>
											</div>
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="doctor-grid-view" data-aos="fade-right">
											<div class="doctor-grid-thumb">
												<a href="#"><img src="<?php echo base_url('assets/theme/img/doc-3.jpg'); ?>" class="img-fluid"
														alt=""></a>
											</div>
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="doctor-grid-view" data-aos="fade-right">
											<div class="doctor-grid-thumb">
												<a href="#"><img src="<?php echo base_url('assets/theme/img/doc-4.jpg'); ?>" class="img-fluid"
														alt=""></a>
											</div>
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="doctor-grid-view" data-aos="fade-right">
											<div class="doctor-grid-thumb">
												<a href="#"><img src="<?php echo base_url('assets/theme/img/doc-5.jpg'); ?>" class="img-fluid"
														alt=""></a>
											</div>
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="doctor-grid-view" data-aos="fade-right">
											<div class="doctor-grid-thumb">
												<a href="#"><img src="<?php echo base_url('assets/theme/img/doc-6.jpg'); ?>" class="img-fluid"
														alt=""></a>
											</div>
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="doctor-grid-view" data-aos="fade-right">
											<div class="doctor-grid-thumb">
												<a href="#"><img src="<?php echo base_url('assets/theme/img/doc-7.jpg'); ?>" class="img-fluid"
														alt=""></a>
											</div>
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="doctor-grid-view" data-aos="fade-right">
											<div class="doctor-grid-thumb">
												<a href="#"><img src="<?php echo base_url('assets/theme/img/doc-8.jpg'); ?>" class="img-fluid"
														alt=""></a>
											</div>
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="Goodup-grid-wrap" data-aos="fade-right">
											<div class="Goodup-grid-upper">
												...
												<div class="Goodup-grid-thumb">
													<a href="#" class="d-block text-center m-auto"><img
															src="<?php echo base_url('assets/theme/img/car/c-1.jpg'); ?>" class="img-fluid" alt=""></a>
												</div>
												<div class="Goodup-rating overlay">
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="Goodup-grid-wrap" data-aos="fade-right">
											<div class="Goodup-grid-upper">
												...
												<div class="Goodup-grid-thumb">
													<a href="#" class="d-block text-center m-auto"><img
															src="<?php echo base_url('assets/theme/img/car/c-2.jpg'); ?>" class="img-fluid" alt=""></a>
												</div>
												<div class="Goodup-rating overlay">
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="Goodup-grid-wrap" data-aos="fade-right">
											<div class="Goodup-grid-upper">
												...
												<div class="Goodup-grid-thumb">
													<a href="#" class="d-block text-center m-auto"><img
															src="<?php echo base_url('assets/theme/img/car/c-3.jpg'); ?>" class="img-fluid" alt=""></a>
												</div>
												<div class="Goodup-rating overlay">
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="Goodup-grid-wrap" data-aos="fade-right">
											<div class="Goodup-grid-upper">
												...
												<div class="Goodup-grid-thumb">
													<a href="#" class="d-block text-center m-auto"><img
															src="<?php echo base_url('assets/theme/img/car/c-4.jpg'); ?>" class="img-fluid" alt=""></a>
												</div>
												<div class="Goodup-rating overlay">
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="Goodup-grid-wrap" data-aos="fade-right">
											<div class="Goodup-grid-upper">
												...
												<div class="Goodup-grid-thumb">
													<a href="#" class="d-block text-center m-auto"><img
															src="<?php echo base_url('assets/theme/img/car/c-5.jpg'); ?>" class="img-fluid" alt=""></a>
												</div>
												<div class="Goodup-rating overlay">
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="Goodup-grid-wrap" data-aos="fade-right">
											<div class="Goodup-grid-upper">
												...
												<div class="Goodup-grid-thumb">
													<a href="#" class="d-block text-center m-auto"><img
															src="<?php echo base_url('assets/theme/img/car/c-6.jpg'); ?>" class="img-fluid" alt=""></a>
												</div>
												<div class="Goodup-rating overlay">
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="Goodup-grid-wrap" data-aos="fade-right">
											<div class="Goodup-grid-upper">
												...
												<div class="Goodup-grid-thumb">
													<a href="#" class="d-block text-center m-auto"><img
															src="<?php echo base_url('assets/theme/img/car/c-7.jpg'); ?>" class="img-fluid" alt=""></a>
												</div>
												<div class="Goodup-rating overlay">
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="Goodup-grid-wrap" data-aos="fade-right">
											<div class="Goodup-grid-upper">
												...
												<div class="Goodup-grid-thumb">
													<a href="#" class="d-block text-center m-auto"><img
															src="<?php echo base_url('assets/theme/img/car/c-8.jpg'); ?>" class="img-fluid" alt=""></a>
												</div>
												<div class="Goodup-rating overlay">
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="Goodup-grid-wrap" data-aos="fade-right">
											<div class="Goodup-grid-upper">
												...
												<div class="Goodup-grid-thumb">
													<a href="#" class="d-block text-center m-auto"><img
															src="<?php echo base_url('assets/theme/img/real/r-1.jpg'); ?>" class="img-fluid" alt=""></a>
												</div>
												<div class="Goodup-rating overlay">
													<div class="Goodup-prt-price">$<span>30,999</span></div>
												</div>
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="Goodup-grid-wrap" data-aos="fade-right">
											<div class="Goodup-grid-upper">
												...
												<div class="Goodup-grid-thumb">
													<a href="#" class="d-block text-center m-auto"><img
															src="<?php echo base_url('assets/theme/img/real/r-2.jpg'); ?>" class="img-fluid" alt=""></a>
												</div>
												<div class="Goodup-rating overlay">
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="Goodup-grid-wrap" data-aos="fade-right">
											<div class="Goodup-grid-upper">
												...
												<div class="Goodup-grid-thumb">
													<a href="#" class="d-block text-center m-auto"><img
															src="<?php echo base_url('assets/theme/img/real/r-3.jpg'); ?>" class="img-fluid" alt=""></a>
												</div>
												<div class="Goodup-rating overlay">
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="Goodup-grid-wrap" data-aos="fade-right">
											<div class="Goodup-grid-upper">
												...
												<div class="Goodup-grid-thumb">
													<a href="#" class="d-block text-center m-auto"><img
															src="<?php echo base_url('assets/theme/img/real/r-4.jpg'); ?>" class="img-fluid" alt=""></a>
												</div>
												<div class="Goodup-rating overlay">
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="Goodup-grid-wrap" data-aos="fade-right">
											<div class="Goodup-grid-upper">
												...
												<div class="Goodup-grid-thumb">
													<a href="#" class="d-block text-center m-auto"><img
															src="<?php echo base_url('assets/theme/img/real/r-5.jpg'); ?>" class="img-fluid" alt=""></a>
												</div>
												<div class="Goodup-rating overlay">
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="Goodup-grid-wrap" data-aos="fade-right">
											<div class="Goodup-grid-upper">
												...
												<div class="Goodup-grid-thumb">
													<a href="#" class="d-block text-center m-auto"><img
															src="<?php echo base_url('assets/theme/img/real/r-6.jpg'); ?>" class="img-fluid" alt=""></a>
												</div>
												<div class="Goodup-rating overlay">
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="Goodup-grid-wrap" data-aos="fade-right">
											<div class="Goodup-grid-upper">
												...
												<div class="Goodup-grid-thumb">
													<a href="#" class="d-block text-center m-auto"><img
															src="<?php echo base_url('assets/theme/img/real/r-7.jpg'); ?>" class="img-fluid" alt=""></a>
												</div>
												<div class="Goodup-rating overlay">
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="Goodup-grid-wrap" data-aos="fade-right">
											<div class="Goodup-grid-upper">
												...
												<div class="Goodup-grid-thumb">
													<a href="#" class="d-block text-center m-auto"><img
															src="<?php echo base_url('assets/theme/img/rooms/1.jpg'); ?>" class="img-fluid" alt=""></a>
												</div>
												<div class="Goodup-rating overlay">
													<div class="Goodup-pr-average high">4.2</div>
													<div class="Goodup-aldeio">
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="Goodup-grid-wrap" data-aos="fade-right">
											<div class="Goodup-grid-upper">
												...
												<div class="Goodup-grid-thumb">
													<a href="#" class="d-block text-center m-auto"><img
															src="<?php echo base_url('assets/theme/img/rooms/2.jpg'); ?>" class="img-fluid" alt=""></a>
												</div>
												<div class="Goodup-rating overlay">
													<div class="Goodup-pr-average high">4.2</div>
													<div class="Goodup-aldeio">
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="Goodup-grid-wrap" data-aos="fade-right">
											<div class="Goodup-grid-upper">
												...
												<div class="Goodup-grid-thumb">
													<a href="#" class="d-block text-center m-auto"><img
															src="<?php echo base_url('assets/theme/img/rooms/3.jpg'); ?>" class="img-fluid" alt=""></a>
												</div>
												<div class="Goodup-rating overlay">
													<div class="Goodup-pr-average high">4.2</div>
													<div class="Goodup-aldeio">
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="Goodup-grid-wrap" data-aos="fade-right">
											<div class="Goodup-grid-upper">
												...
												<div class="Goodup-grid-thumb">
													<a href="#" class="d-block text-center m-auto"><img
															src="<?php echo base_url('assets/theme/img/rooms/4.jpg'); ?>" class="img-fluid" alt=""></a>
												</div>
												<div class="Goodup-rating overlay">
													<div class="Goodup-pr-average high">4.2</div>
													<div class="Goodup-aldeio">
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="Goodup-grid-wrap" data-aos="fade-right">
											<div class="Goodup-grid-upper">
												...
												<div class="Goodup-grid-thumb">
													<a href="#" class="d-block text-center m-auto"><img
															src="<?php echo base_url('assets/theme/img/rooms/5.jpg'); ?>" class="img-fluid" alt=""></a>
												</div>
												<div class="Goodup-rating overlay">
													<div class="Goodup-pr-average high">4.2</div>
													<div class="Goodup-aldeio">
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="Goodup-grid-wrap" data-aos="fade-right">
											<div class="Goodup-grid-upper">
												...
												<div class="Goodup-grid-thumb">
													<a href="#" class="d-block text-center m-auto"><img
															src="<?php echo base_url('assets/theme/img/rooms/6.jpg'); ?>" class="img-fluid" alt=""></a>
												</div>
												<div class="Goodup-rating overlay">
													<div class="Goodup-pr-average high">4.2</div>
													<div class="Goodup-aldeio">
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="Goodup-grid-wrap" data-aos="fade-right">
											<div class="Goodup-grid-upper">
												...
												<div class="Goodup-grid-thumb">
													<a href="#" class="d-block text-center m-auto"><img
															src="<?php echo base_url('assets/theme/img/rooms/7.jpg'); ?>" class="img-fluid" alt=""></a>
												</div>
												<div class="Goodup-rating overlay">
													<div class="Goodup-pr-average high">4.2</div>
													<div class="Goodup-aldeio">
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="Goodup-grid-wrap" data-aos="fade-right">
											<div class="Goodup-grid-upper">
												...
												<div class="Goodup-grid-thumb">
													<a href="#" class="d-block text-center m-auto"><img
															src="<?php echo base_url('assets/theme/img/rooms/8.jpg'); ?>" class="img-fluid" alt=""></a>
												</div>
												<div class="Goodup-rating overlay">
													<div class="Goodup-pr-average high">4.2</div>
													<div class="Goodup-aldeio">
							...
							<div class="tab-pane fade" id="jobs" role="tabpanel" aria-labelledby="jobs-tab">
								<div class="row justify-content-center">
									...
									<!-- Single Jobs -->
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="_jb_list72" data-aos="fade-right">
											...
											<div class="_jb_list72_flex">
												<div class="_jb_list72_first">
													<div class="_jb_list72_yhumb">
														<img src="<?php echo base_url('assets/theme/img/c-1.png'); ?>" class="img-fluid" alt="">
													</div>
												</div>
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="_jb_list72" data-aos="fade-right">
											...
											<div class="_jb_list72_flex">
												<div class="_jb_list72_first">
													<div class="_jb_list72_yhumb">
														<img src="<?php echo base_url('assets/theme/img/c-2.png'); ?>" class="img-fluid" alt="">
													</div>
												</div>
												<div class="_jb_list72_last">
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="_jb_list72" data-aos="fade-right">
											...
											<div class="_jb_list72_flex">
												<div class="_jb_list72_first">
													<div class="_jb_list72_yhumb">
														<img src="<?php echo base_url('assets/theme/img/c-3.png'); ?>" class="img-fluid" alt="">
													</div>
												</div>
												<div class="_jb_list72_last">
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="_jb_list72" data-aos="fade-right">
											...
											<div class="_jb_list72_flex">
												<div class="_jb_list72_first">
													<div class="_jb_list72_yhumb">
														<img src="<?php echo base_url('assets/theme/img/c-4.png'); ?>" class="img-fluid" alt="">
													</div>
												</div>
												<div class="_jb_list72_last">
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="_jb_list72" data-aos="fade-right">
											...
											<div class="_jb_list72_flex">
												<div class="_jb_list72_first">
													<div class="_jb_list72_yhumb">
														<img src="<?php echo base_url('assets/theme/img/c-5.png'); ?>" class="img-fluid" alt="">
													</div>
												</div>
												<div class="_jb_list72_last">
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="_jb_list72" data-aos="fade-right">
											...
											<div class="_jb_list72_flex">
												<div class="_jb_list72_first">
													<div class="_jb_list72_yhumb">
														<img src="<?php echo base_url('assets/theme/img/c-6.png'); ?>" class="img-fluid" alt="">
													</div>
												</div>
												<div class="_jb_list72_last">
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="_jb_list72" data-aos="fade-right">
											...
											<div class="_jb_list72_flex">
												<div class="_jb_list72_first">
													<div class="_jb_list72_yhumb">
														<img src="<?php echo base_url('assets/theme/img/c-7.png'); ?>" class="img-fluid" alt="">
													</div>
												</div>
												<div class="_jb_list72_last">
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="_jb_list72" data-aos="fade-right">
											...
											<div class="_jb_list72_flex">
												<div class="_jb_list72_first">
													<div class="_jb_list72_yhumb">
														<img src="<?php echo base_url('assets/theme/img/c-8.png'); ?>" class="img-fluid" alt="">
													</div>
												</div>
												<div class="_jb_list72_last">
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="_jb_list72" data-aos="fade-right">
											...
											<div class="_jb_list72_flex">
												<div class="_jb_list72_first">
													<div class="_jb_list72_yhumb">
														<img src="<?php echo base_url('assets/theme/img/c-9.png'); ?>" class="img-fluid" alt="">
													</div>
												</div>
												<div class="_jb_list72_last">
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="_jb_list72" data-aos="fade-right">
											...
											<div class="_jb_list72_flex">
												<div class="_jb_list72_first">
													<div class="_jb_list72_yhumb">
														<img src="<?php echo base_url('assets/theme/img/c-10.png'); ?>" class="img-fluid" alt="">
													</div>
												</div>
												<div class="_jb_list72_last">
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="_jb_list72" data-aos="fade-right">
											...
											<div class="_jb_list72_flex">
												<div class="_jb_list72_first">
													<div class="_jb_list72_yhumb">
														<img src="<?php echo base_url('assets/theme/img/c-11.png'); ?>" class="img-fluid" alt="">
													</div>
												</div>
												<div class="_jb_list72_last">
													<h4 class="_jb_title"><a href="#">UI/UX
				...
				<div class="row justify-content-center">
					...
					<div class="col-xl-2 col-lg-2 col-md-3 col-sm-4 col-6">
						<div class="empl-thumb text-center px-3 py-4">
							<img src="<?php echo base_url('assets/theme/img/l-1.png'); ?>" class="img-fluid mx-auto" alt="" />
						</div>
					</div>

					<div class="col-xl-2 col-lg-2 col-md-3 col-sm-4 col-6">
						<div class="empl-thumb text-center px-3 py-4">
							<img src="<?php echo base_url('assets/theme/img/l-2.png'); ?>" class="img-fluid mx-auto" alt="" />
						</div>
					</div>

					<div class="col-xl-2 col-lg-2 col-md-3 col-sm-4 col-6">
						<div class="empl-thumb text-center px-3 py-4">
							<img src="<?php echo base_url('assets/theme/img/l-3.png'); ?>" class="img-fluid mx-auto" alt="" />
						</div>
					</div>

					<div class="col-xl-2 col-lg-2 col-md-3 col-sm-4 col-6">
						<div class="empl-thumb text-center px-3 py-4">
							<img src="<?php echo base_url('assets/theme/img/l-4.png'); ?>" class="img-fluid mx-auto" alt="" />
						</div>
					</div>

					<div class="col-xl-2 col-lg-2 col-md-3 col-sm-4 col-6">
						<div class="empl-thumb text-center px-3 py-4">
							<img src="<?php echo base_url('assets/theme/img/l-5.png'); ?>" class="img-fluid mx-auto" alt="" />
						</div>
					</div>

					<div class="col-xl-2 col-lg-2 col-md-3 col-sm-4 col-6">
						<div class="empl-thumb text-center px-3 py-4">
							<img src="<?php echo base_url('assets/theme/img/l-6.png'); ?>" class="img-fluid mx-auto" alt="" />
						</div>
					</div>

					<div class="col-xl-2 col-lg-2 col-md-3 col-sm-4 col-6">
						<div class="empl-thumb text-center px-3 py-4">
							<img src="<?php echo base_url('assets/theme/img/l-7.png'); ?>" class="img-fluid mx-auto" alt="" />
						</div>
					</div>

					<div class="col-xl-2 col-lg-2 col-md-3 col-sm-4 col-6">
						<div class="empl-thumb text-center px-3 py-4">
							<img src="<?php echo base_url('assets/theme/img/l-8.png'); ?>" class="img-fluid mx-auto" alt="" />
						</div>
					</div>

					<div class="col-xl-2 col-lg-2 col-md-3 col-sm-4 col-6">
						<div class="empl-thumb text-center px-3 py-4">
							<img src="<?php echo base_url('assets/theme/img/l-9.png'); ?>" class="img-fluid mx-auto" alt="" />
						</div>
					</div>

					<div class="col-xl-2 col-lg-2 col-md-3 col-sm-4 col-6">
						<div class="empl-thumb text-center px-3 py-4">
							<img src="<?php echo base_url('assets/theme/img/l-10.png'); ?>" class="img-fluid mx-auto" alt="" />
						</div>
					</div>
		...
		<section class="space min pt-0">
			<div class="container">
				...
				<div class="row justify-content-center">
					<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
						<div class="sec_title position-relative text-center mb-4" data-aos="fade-down">
				...
				<div class="row justify-content-center">
					...
					<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
						<div class="gup_blg_grid_box" data-aos="fade-right">
							<div class="gup_blg_grid_thumb">
								<a href="#"><img src="<?php echo base_url('assets/theme/img/b-4.jpg'); ?>" class="img-fluid" alt=""></a>
							</div>
									...
									<div class="crs_fl_first">
										<div class="crs_tutor">
											<div class="crs_tutor_thumb"><a href="javascript:void(0);"><img
														src="<?php echo base_url('assets/theme/img/team-2.jpg'); ?>" class="img-fluid circle" width="35"
														alt=""></a></div>
										</div>
									</div>
					...
					<!-- Single Item -->
					<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
						<div class="gup_blg_grid_box" data-aos="fade-up">
							<div class="gup_blg_grid_thumb">
								<a href="#"><img src="<?php echo base_url('assets/theme/img/b-5.jpg'); ?>" class="img-fluid" alt=""></a>
							</div>
							<div class="gup_blg_grid_caption">
							...
							<div class="crs_grid_foot">
								<div
									...
									<div class="crs_fl_first">
										<div class="crs_tutor">
											<div class="crs_tutor_thumb"><a href="javascript:void(0);"><img
														src="<?php echo base_url('assets/theme/img/team-3.jpg'); ?>" class="img-fluid circle" width="35"
														alt=""></a></div>
										</div>
									</div>
									<div class="crs_fl_last">
					...
					<!-- Single Item -->
					<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
						<div class="gup_blg_grid_box" data-aos="fade-left">
							<div class="gup_blg_grid_thumb">
								<a href="#"><img src="<?php echo base_url('assets/theme/img/b-6.jpg'); ?>" class="img-fluid" alt=""></a>
							</div>
							<div class="gup_blg_grid_caption">
							...
							<div class="crs_grid_foot">
								<div
									...
									<div class="crs_fl_first">
										<div class="crs_tutor">
											<div class="crs_tutor_thumb"><a href="javascript:void(0);"><img
														src="<?php echo base_url('assets/theme/img/team-5.jpg'); ?>" class="img-fluid circle" width="35"
														alt=""></a></div>
										</div>
									</div>
									<div class="crs_fl_last">
			...
			<div class="container">
				<div class="row align-items-center justify-content-between">
						...
						<div class="content_block_2 pr-3 py-4">
							<div class="content-box">
								<div class="sec-title light">
									<p class="theme-cl px-3 py-1 rounded bg-light-danger d-inline-flex">Download apps
									</p>
								...
								<div class="btn-box clearfix mt-5">
									<a href="index.html" class="download-btn play-store me-1 d-inline-flex"><img
											src="<?php echo base_url('assets/theme/img/ios.png'); ?>" width="200" alt="" /></a>
									<a href="index.html" class="download-btn play-store ms-2 mb-1 d-inline-flex"><img
											src="<?php echo base_url('assets/theme/img/and.png'); ?>" width="200" alt="" /></a>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="col-lg-5 col-md-12 col-sm-12 image-column">
						<div class="image-box">
							<figure class="image"><img src="<?php echo base_url('assets/theme/img/app.png'); ?>" class="img-fluid" alt=""></figure>
						</div>
					</div>
				</div>
			</div>
