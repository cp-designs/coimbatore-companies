				...
				<div class="container">
					<div class="row">
						...
						<div class="col-xl-3 col-lg-4 col-md-12 col-sm-12">
							<div class="bg-white rounded mb-4" data-aos="fade-left">							
								...
								<div class="col-xl-12 col-lg-12 col-md-12 col-12">
									<!-- <nav aria-label="breadcrumb">
										<ol class="breadcrumb">
											...
											<li class="breadcrumb-item"><a href="#">San Antonio</a></li>
											<li class="breadcrumb-item active" aria-current="page">Restaurants</li>
										</ol>
									</nav> -->
									<div class="">
										<h2 class="ft-bold" data-aos="fade-down">The Best 10 Restaurants in Coimbatore</h2>
									</div>
								</div>
								
								<div class="col-xl-12 col-lg-12 col-md-12 col-12" data-aos="fade-right" id="card-container">
									<div class="d-block grouping-listings">
										<div class="d-block grouping-listings-title" data-aos="fade-up">
											...
											<div class="vrt-list-wrap">
												<div class="vrt-list-wrap-head">
													...
													<div class="vrt-list-content">
														<h4 class="mb-0 ft-medium"><a href="listing-search-v1" class="text-dark fs-md">Incredible Pizza - San Antonio’s<span class="verified-badge"><i class="fas fa-check-circle"></i></span></a></h4>
														<div class="Goodup-ft-first">
															...
															<div class="Goodup-price-range">
																<span class="small ft-medium">34 Reviews</span>
														...
														<div class="vrt-list-desc">
															<p class="vrt-qgunke">Great service and great food. We asked for a romantic table and they put us in a corner section at a candle lit table…<span class="ft-bold"><a href="javascript:void(0);" class="d14ixh">more</a></span></p>
														</div>
														
														<div class="vrt-list-amenties">
															<ul >
																<li><div class="vrt-amens no"><span>Outdoor Dining</span></div></li>
																<li><div class="vrt-amens yes"><span>Pets Allow</span></div></li>
																<li><div class="vrt-amens yes"><span>Delivery</span></div></li>
																<li><div class="vrt-amens no"><span>Parking</span></div></li>
																<li><div class="vrt-amens yes"><span>Takeout</span></div></li>
															</ul>
														</div>
													</div>
												</div>
											...
											<div class="vrt-list-wrap">
												<div class="vrt-list-wrap-head">
													...
													<div class="vrt-list-content">
														...
														<div class="vrt-list-sts">
															<p class="vrt-qgunke"><span class="ft-bold d14ixhs">Open</span> til 8:00 PM</p>
														</div>
