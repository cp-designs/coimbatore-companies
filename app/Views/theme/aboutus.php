<!-- ======================= Top Breadcrubms ======================== -->
<section class="about-bg bg-cover" style="background:url(<?php echo base_url('assets/theme/img/about.jpg'); ?>) no-repeat;">
				<div class="container">
					<div class="row">
					...
					<div class="row justify-content-center">
						...
						<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
							<div class="Goodup-author-wrap">
								...
								<div class="Goodup-author-thumb"><a href="author-detail.html"><img src="<?php echo base_url('assets/theme/img/t-1.png'); ?>" class="img-fluid circle" alt=""></a></div>
						...
						<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
							<div class="Goodup-author-wrap">
								<div class="Goodup-author-thumb"><a href="author-detail.html"><img src=" <?php echo base_url('assets/theme/img/t-2.png'); ?>" class="img-fluid circle" alt=""></a></div>
								<div class="Goodup-author-caption">
						...
						<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
							<div class="Goodup-author-wrap">
								...
								<div class="Goodup-author-thumb"><a href="author-detail.html"><img src="<?php echo base_url('assets/theme/img/t-3.png'); ?>" class="img-fluid circle" alt=""></a></div>
								<div class="Goodup-author-caption">
						...
						<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
							<div class="Goodup-author-wrap">
								<div class="Goodup-author-thumb"><a href="author-detail.html"><img src="<?php echo base_url('assets/theme/img/t-4.png'); ?>" class="img-fluid circle" alt=""></a></div>
								<div class="Goodup-author-caption">
						...
						<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
							<div class="Goodup-author-wrap">
								<div class="Goodup-author-tag new">New</div>
								<div class="Goodup-author-thumb"><a href="author-detail.html"><img src="<?php echo base_url('assets/theme/img/t-5.png'); ?>" class="img-fluid circle" alt=""></a></div>
								<div class="Goodup-author-caption">
						...
						<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
							<div class="Goodup-author-wrap">
								<div class="Goodup-author-thumb"><a href="author-detail.html"><img src="<?php echo base_url('assets/theme/img/t-6.png'); ?>" class="img-fluid circle" alt=""></a></div>
								<div class="Goodup-author-caption">
						...
						<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
							<div class="Goodup-author-wrap">
								<div class="Goodup-author-tag popular">Popular</div>
								<div class="Goodup-author-thumb"><a href="author-detail.html"><img src="<?php echo base_url('assets/theme/img/t-7.png'); ?>" class="img-fluid circle" alt=""></a></div>
								<div class="Goodup-author-caption">
						...
						<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
							<div class="Goodup-author-wrap">
								<div class="Goodup-author-tag new">New</div>
								<div class="Goodup-author-thumb"><a href="author-detail.html"><img src="<?php echo base_url('assets/theme/img/t-8.png'); ?>" class="img-fluid circle" alt=""></a></div>
								<div class="Goodup-author-caption">
				...
				<div class="container">
					...
					<div class="row justify-content-center">
						...
						<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
							<div class="gup_blg_grid_box">
								<div class="gup_blg_grid_thumb">
									<a href="blog-detail.html"><img src="<?php echo base_url('assets/theme/img/b-4.jpg'); ?>" class="img-fluid" alt=""></a>
								</div>
								...
								<div class="crs_grid_foot">
									<div class="crs_flex d-flex align-items-center justify-content-between br-top px-3 py-2">
										<div class="crs_fl_first">
											<div class="crs_tutor">
												<div class="crs_tutor_thumb"><a href="javascript:void(0);"><img src="<?php echo base_url('assets/theme/img/team-2.jpg'); ?>" class="img-fluid circle" width="35" alt=""></a></div>
											</div>
										</div>
						...
						<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
							<div class="gup_blg_grid_box">
								<div class="gup_blg_grid_thumb">
									<a href="blog-detail.html"><img src="<?php echo base_url('assets/theme/img/b-5.jpg'); ?>" class="img-fluid" alt=""></a>
								</div>
								<div class="gup_blg_grid_caption">
								...
								<div class="crs_grid_foot">
									<div class="crs_flex d-flex align-items-center justify-content-between br-top px-3 py-2">
										<div class="crs_fl_first">
											<div class="crs_tutor">
												<div class="crs_tutor_thumb"><a href="javascript:void(0);"><img src="<?php echo base_url('assets/theme/img/team-3.jpg'); ?>" class="img-fluid circle" width="35" alt=""></a></div>
											</div>
										</div>
										<div class="crs_fl_last">
											<div class="foot_list_info">
						...
						<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
							<div class="gup_blg_grid_box">
								<div class="gup_blg_grid_thumb">
									<a href="blog-detail.html"><img src="<?php echo base_url('assets/theme/img/b-6.jpg'); ?>" class="img-fluid" alt=""></a>
								</div>
								<div class="gup_blg_grid_caption">
								...
								<div class="crs_grid_foot">
									<div class="crs_flex d-flex align-items-center justify-content-between br-top px-3 py-2">
										<div class="crs_fl_first">
											<div class="crs_tutor">
												<div class="crs_tutor_thumb"><a href="javascript:void(0);"><img src="<?php echo base_url('assets/theme/img/team-5.jpg'); ?>" class="img-fluid circle" width="35" alt=""></a></div>
											</div>
										</div>
										<div class="crs_fl_last">
											<div class="foot_list_info">
